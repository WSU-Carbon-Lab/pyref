...
class Fitter(CurveFitter):
    ...
    def sample(  # type: ignore[override]
        ...
        **sampler_kws: Any,
        ...
        """
        Sample from the objective using MCMC.
        ...
        callback : Callable[[np.ndarray, np.ndarray], None] | None, optional
            Callback function for each iteration.
        verbose : bool, optional
            Whether to print progress.
        pool : Callable | None, optional
            Pool for parallelization.
        sampler_kws : dict, optional
        ...
        with MapWrapper(pool):
            for state in self.sampler.sample(
                ...
                if (
                    ...
                    and state.coords is not None
                    and state.log_prob is not None
                ):
